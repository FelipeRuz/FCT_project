...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-02-2018 a las 15:52:32
...
INSERT INTO `fct` (`cod_fct`, `dni_prof`, `dni_alumno`, `cif_empresa`, `fecha`) VALUES
('1', '11111111A', '12329572Y', '77777777Z', '2018-02-06'),
('2', '33333333A', '12941235Z', '88888888Z', '2018-02-13');
...
INSERT INTO `profesor` (`dni`, `nombre`, `ape1`, `ape2`, `rol`, `nick`, `pass`, `tlf`, `email`, `foto`) VALUES
('11111111A', 'Alfonso', 'Rodriguez', 'Lopez', 'PROFESOR', 'marc', '$2a$04$JVXcgjgu8XqJQB15CnX50OEuycRSBWVorcF9l1L0/wIjQ5gAWBVzK', '111111111', 'alf_prof@gmail.com', ''),
('33333333A', 'Antonio', 'García', 'Portillo', 'PROFESOR', 'profagp', '$2a$04$JVXcgjgu8XqJQB15CnX50OEuycRSBWVorcF9l1L0/wIjQ5gAWBVzK', '333333333', 'ant_prof@gmail.com', ''),
('44444444R', 'Diego', 'Robles', 'Perez', 'DIRECCIÓN', 'diegoprof', '$2a$04$JVXcgjgu8XqJQB15CnX50OEuycRSBWVorcF9l1L0/wIjQ5gAWBVzK', '986542799', 'diego_prof@gmail.com', '');
